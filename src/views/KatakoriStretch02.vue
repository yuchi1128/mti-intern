  ...
  <div class="container">
    <div class="card">
      ...
      <div class="stretch-content">
        ...
        <button @click="goToNextStretch" class="button next-stretch-button">次のストレッチへ</button>
      </div>
    </div>
  </div>
</template>
...
const fetchStretchData = async () => {
  try {
    const response = await fetch('https://os21ehqa5l.execute-api.ap-northeast-1.amazonaws.com/user/stretchcontent?Stretch_id=katakori-02&Severity=3');
