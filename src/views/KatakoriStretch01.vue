...
const fetchStretchData = async () => {
  try {
    const response = await fetch('https://os21ehqa5l.execute-api.ap-northeast-1.amazonaws.com/user/stretchcontent?Stretch_id=katakori-01&Severity=3');
